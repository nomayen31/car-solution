...
import img1 from "../../assets/images/login/login1.jpg";
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2">
                <div class="relative flex items-end px-4 pb-10 pt-60 sm:pb-16 md:justify-center lg:pb-24 bg-gray-50 sm:px-6 lg:px-8">
                    <div class="absolute inset-0">
                        <img class="object-cover object-top w-full h-full" src={img1} alt="" />
                    </div>
                        ...
                        <form onSubmit={handleLogin} class="mt-8">
                            <div class="space-y-5">
                                ...
                                <div>
                                    ...
                                    <p class="mt-2 text-base text-gray-600 text-center">Or Sign In with</p>
                                </div>
                            </div>
                        </form>
